package filedstrength.jingxun.com.meter.Constant;


public class NewSendCommendHelper {
    ...
    public static String setCDMA(){
        String cmd = "23DC02";
        return cmd;
    }
    public static String setWCDMA(){
        String cmd = "23DC03";
        return cmd;
    }
    public static String setTDS(){
        String cmd = "23DC01";
        return cmd;
    }
    public static String setGSM(){
        String cmd = "23DC00";
        return cmd;
    }
